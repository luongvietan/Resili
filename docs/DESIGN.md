...
Resili looks like a developer tool with the typography of an editorial.
...
Resili ships a four-family stack:
...
- The brightest pixel on the canvas. Used for "Get started", "Sign up", "Try Resili".
